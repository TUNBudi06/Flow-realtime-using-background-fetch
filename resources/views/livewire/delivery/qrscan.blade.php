...
//        data looks "6576;20251023;SF225GWZRE42S;100003;SF225S100003;SF225GWZRE42S100003"
    ...
    {
        // Auto-generate keterangan based on form data - for delivery
        return "Tractor No {$this->no_tractor} dengan kode {$this->id_tractor} siap untuk delivery";
    }
    ...
    public function save()
    {
        ...
        $this->dispatch('notify', [
            'type' => 'success',
            'message' => 'Data delivery tractor berhasil disimpan!'
        ]);
...
<div>
    <div class="max-w-4xl mx-auto p-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Delivery Tractor</h2>
            ...
            <div class="mb-6">
                ...
                @if(!$isScanning)
                    <div
                        class="mb-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-300 dark:border-gray-600">
                ...
                @if($isScanning)
                    <div class="relative">
                        <video id="qr-video"
                               class="w-full rounded-lg border-4 border-blue-500 dark:border-blue-600"></video>
                        <x-button-loading
                            wire:click="stopScanning"
                            type="button"
                            color="red"
                            loadingText="Menghentikan..."
                ...
                @if($keterangan && !$isScanning)
                    <div class="mt-4 p-4 bg-green-50 dark:bg-green-900 border-l-4 border-green-500 rounded-lg">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-sm font-semibold text-green-800 dark:text-green-200 mb-1">QR Code
                                    Terdeteksi!</h4>
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    @else
                        <div class="mt-3 pt-3 border-t border-gray-300 dark:border-gray-600">
                            <p class="text-xs italic text-gray-500 dark:text-gray-500">Keterangan akan muncul setelah QR
                                code ter-scan</p>
                        </div>
                    @endif
                </div>
    ...
    <script type="module">
        ...
        const scanFromFile = async (imageUrl) => {
            try {
                ...
                Livewire.dispatch('notify', {type: 'error', message: 'Failed to scan QR code from file.'});
            }
        };
